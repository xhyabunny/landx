...
export const Header = () => {
	...
	return (
		<nav className={`border-gray-200 fixed z-[999] transition-all ${isSideMenuOpen ? "w-[calc(100vw-380px)] opacity-0 md:opacity-100" : "w-full"} bg-background ${isSideMenuOpen ? "pb-0" : "pb-4"}`}>
